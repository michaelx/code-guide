...
- Don’t include a trailing slash in self-closing elements (e.g. `<br>`, `<hr>`, `<img>`, and `<input>`), as the [HTML5 spec](http://dev.w3.org/html5/spec-author-view/syntax.html#syntax-start-tag) says they’re optional. 
